...
/// @title ERC1155 Bridge Receiver Contract
/// @author @yashnaman
/// @dev To bridge tokens back to the destination chain, transfer them to this contract address.
/// Then, visit https://axelarscan.io/ with the transaction hash to pay the required bridging gas fees.
contract ERC1155BridgeReceiver is ERC1155Bridge, ERC1155 {
    constructor(address _gateway, address _destinationErc1155Token, string memory _destinationChain, string memory uri_)
        ERC1155(uri_)
        ERC1155Bridge(_gateway, address(this), _destinationErc1155Token, _destinationChain)
    {}
